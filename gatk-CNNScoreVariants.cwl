...
- doc: 'If true, adds a command line header line to created VCF files.  Default value:
  ...
  type: boolean?
- doc: 'Neural Net architecture configuration json file  Default value: null.'
  id: architecture
  inputBinding:
    position: 0
    prefix: --architecture
...
- doc: 'Read filters to be disabled before analysis  This argument may be specified
    0 or more times. Default value: null. Possible Values: {ReadGroupBlackListReadFilter,
...
- doc: ':StringOne or more genomic intervals to exclude from processing  This argument
  ...
  type: boolean?
- doc: 'If set will filter symbolic and and structural variants from the input VCF  Default
    value: false. Possible values: {true, false}'
  id: filter_symbolic_and_sv
  inputBinding:
    position: 0
...
- doc: 'display the version number for this tool  Default value: false. Possible values:
  ...
  inputBinding:
    ...
    prefix: --version
  type: boolean?
- doc: 'Keras model HD5 file with neural net weights.  Default value: null.'
  id: weights
  inputBinding:
    position: 0
    prefix: --weights
  type: string?
- doc: 'Neural Net input window size  Default value: 128.'
  id: window_size
  inputBinding:
    position: 0
    prefix: --window-size
...
- doc: 'Disable all tool default read filters (WARNING: many tools will not function
  ...
  type: boolean?
- doc: 'Size of batches for python to do inference on.  Default value: 256.'
  id: inference_batch_size
  inputBinding:
    position: 0
    prefix: --inference-batch-size
  type: int?
- doc: 'Number of inter-op parallelism threads to use for Tensorflow  Default value:
    0.'
  id: inter_op_threads
  inputBinding:
    position: 0
  ...
  type: int?
- doc: 'Number of intra-op parallelism threads to use for Tensorflow  Default value:
    0.'
  id: intra_op_threads
  inputBinding:
    position: 0
  ...
  type: int?
- doc: 'Optional directory where tensors can be saved for debugging or visualization.  Default
    value: .'
...
- doc: 'display hidden arguments  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --showHidden
  type: boolean?
- doc: 'Size of data to queue for python streaming.  Default value: 512.'
  id: transfer_batch_size
  inputBinding:
    position: 0
...
- doc: Platform unit (PU) to filter out  This argument must be specified at least
  ...
  type: string
- doc: ':StringThe name of the read group to filter out  This argument may be specified
    0 or more times. Default value: [ID:ArtificialHaplotypeRG, ID:ArtificialHaplotype].'
