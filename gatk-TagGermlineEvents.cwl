...
cwlVersion: v1.0
id: gatk_TagGermlineEvents
inputs:
- doc: Matched normal called segment file.  Required.
  id: called_matched_normal_seg_file
  inputBinding:
    position: 0
    prefix: --called-matched-normal-seg-file
  type: File
- doc: Output TSV file identical to the tumor segment file, but with additional germline
    tag column (POSSIBLE_GERMLINE).  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: Reference sequence file  Required.
  ...
  inputBinding:
    ...
    prefix: --reference
  type: string
- doc: the output will be a copy of this file with the additional information.  Required.
  id: segments
  inputBinding:
    position: 0
    prefix: --segments
...
- doc: 'If specified, do not check the sequence dictionaries from our inputs for compatibility.
  ...
  type: boolean?
- doc: 'Amount of padding, in bases, to allow a breakpoint match.  Default value:
    1000.'
  id: endpoint_padding
  inputBinding:
    position: 0
...
- doc: 'BAM/SAM/CRAM file containing reads  This argument may be specified 0 or more
  ...
  inputBinding:
    ...
    prefix: --input
  type: string?
- doc: 'Column header to use for the call (amplified, neutral, or deleted).  Default
    value: CALL.'
