...
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: :FeatureInput     One or more VCF files  This argument must be specified at
    least once. Required.
  id: variant
  inputBinding:
    position: 0
...
- doc: 'Size of the cloud-only prefetch buffer (in MB; 0 to disable).  Default value:
  ...
  type: int?
- doc: ':CountPileupType Handling of overlapping reads from the same fragment  Default
    value: COUNT_FRAGMENTS_REQUIRE_SAME_BASE. Possible values: {COUNT_READS, COUNT_FRAGMENTS,
...
- doc: 'Read filters to be disabled before analysis  This argument may be specified
    0 or more times. Default value: null. Possible Values: {HasReadGroupReadFilter,
    MappedReadFilter, MatchingBasesAndQualsReadFilter, NotDuplicateReadFilter, NotSecondaryAlignmentReadFilter,
...
- doc: 'Maximum number of reads to retain per sample per locus. Reads above this threshold
  ...
  type: int?
- doc: ':Byte  Minimum base quality  Default value: 0.'
  id: min_base_quality
  inputBinding:
    position: 0
...
- doc: ''
  ...
  type: int
- doc: 'Minimum read mapping quality  Default value: 0.'
  id: min_mapping_quality
  inputBinding:
    position: 0
    prefix: --min-mapping-quality
  type: int?
- doc: 'Output file (if not provided, defaults to STDOUT)  Default value: null.'
  id: output
  inputBinding:
    position: 0
    prefix: --output
  type: File?
- doc: ':OUTPUT_FORMAT Format of the output file  Default value: RTABLE. Possible
    values: {TABLE, RTABLE, CSV}'
  id: output_format
  inputBinding:
    position: 0
