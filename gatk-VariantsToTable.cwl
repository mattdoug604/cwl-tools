...
inputs:
- doc: to which the tab-delimited table is written  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: ':StringOne or more genomic intervals to exclude from processing  This argument
  ...
  type: boolean?
- doc: 'The name of a standard VCF field or an INFO field to include in the output
    table  This argument may be specified 0 or more times. Default value: null.'
  id: fields
  inputBinding:
    position: 0
    prefix: --fields
...
- doc: 'Project to bill when accessing "requester pays" buckets. If unset, these buckets
  ...
  type: string?
- doc: 'The name of a genotype field to include in the output table  This argument
    may be specified 0 or more times. Default value: null.'
  id: genotype_fields
  inputBinding:
    position: 0
    prefix: --genotype-fields
  type: string?
...
- doc: "If true, don't emit genotype fields when writing vcf file output.  Default\
  ...
  type: boolean?
- doc: 'Split multi-allelic records into multiple lines  Default value: false. Possible
    values: {true, false}'
  id: split_multi_allelic
  inputBinding:
    position: 0
    prefix: --split-multi-allelic
  type: boolean?
...
- doc: 'Disable all tool default read filters (WARNING: many tools will not function
  ...
  type: boolean?
- doc: 'Fail on missing data  Default value: false. Possible values: {true, false}'
  id: error_if_missing_data
  inputBinding:
    position: 0
    prefix: --error-if-missing-data
  type: boolean?
- doc: ':BooleanProduce molten output  Default value: false. Possible values: {true,
    false}'
  id: moltenize
  inputBinding:
    position: 0
    prefix: --moltenize
  type: boolean?
- doc: 'Include filtered records in the output  Default value: false. Possible values:
    {true, false}'
  id: show_filtered
  inputBinding:
    position: 0
    prefix: --show-filtered
  type: boolean?
