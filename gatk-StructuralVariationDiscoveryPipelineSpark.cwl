...
cwlVersion: v1.0
id: gatk_StructuralVariationDiscoveryPipelineSpark
inputs:
...
- doc: containing ubiquitous kmer list. see FindBadGenomicKmersSpark to generate it.
  ...
  type: string
- doc: for VCF output, including those from experimental interpretation tool if so
    requested, will be created if not present; sample name will be appended after
    the provided argument  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'Disable all tool default read filters (WARNING: many tools will not function
  ...
  type: boolean?
- doc: 'flag to signal that user wants to run experimental interpretation tool as
    well  Default value: false. Possible values: {true, false}'
  id: exp_interpret
  inputBinding:
    position: 0
    prefix: --exp-interpret
  type: boolean?
