...
cwlVersion: v1.0
id: gatk_AddCommentsToBam
inputs:
- doc: picard.jar AddCommentsToBam \<br />      I=input.bam \<br />      O=modified_bam.bam
    \<br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: Comments to add to the BAM file  This argument must be specified at least once.
    Required.
  id: COMMENT
  inputBinding:
    position: 0
    prefix: --COMMENT
  type: string
- doc: Input BAM file to add a comment to the header  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: Output BAM file to write results  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
