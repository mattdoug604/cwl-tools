...
cwlVersion: v1.0
id: gatk_VcfFormatConverter
inputs:
- doc: picard.jar VcfFormatConverter \<br />      I=input.vcf \<br />      O=output.bcf
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: The BCF or VCF input file.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: The BCF or VCF output file name.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: 'Fail if an index is not available for the input VCF/BCF  Default value: true.
    Possible values: {true, false}'
  id: REQUIRE_INDEX
  inputBinding:
    position: 0
