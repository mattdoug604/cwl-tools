...
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: the output file path  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'For tools that write an output, write the output in multiple pieces (shards)  Default
  ...
  type: boolean?
- doc: ':SparkSortOrder   sort order of the output file  Default value: coordinate.
    Possible values: {coordinate, queryname}'
  id: sort_order
  inputBinding:
    position: 0
    prefix: --sort-order
