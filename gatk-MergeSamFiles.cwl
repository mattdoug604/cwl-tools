...
cwlVersion: v1.0
id: gatk_MergeSamFiles
inputs:
- doc: picard.jar MergeSamFiles \<br />      I=input_1.bam \<br />      I=input_2.bam
    \<br />
  id: jar
  inputBinding:
    position: 0
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'An interval list file that contains the locations of the positions to merge.
    Assume bam are sorted and indexed. The resulting file will contain alignments
    that may overlap with genomic regions outside the requested region. Unmapped reads
    are discarded.  Default value: null.'
  id: INTERVALS
  inputBinding:
    position: 0
    prefix: --INTERVALS
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'Merge the sequence dictionaries  Default value: false. Possible values: {true,
    false}'
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: ':SortOrder    Sort order of output file  Default value: coordinate. Possible
...
- doc: 'Option to create a background thread to encode, compress and write to disk
    the output . The threaded version uses about 20% more CPU and decreases runtime
    by ~20% when writing out a compressed BAM file.  Default value: false. Possible
    values: {true, false}'
  id: USE_THREADING
  inputBinding:
    position: 0
