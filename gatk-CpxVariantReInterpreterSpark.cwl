...
cwlVersion: v1.0
id: gatk_CpxVariantReInterpreterSpark
inputs:
- doc: containing complex variants as output by GATK-SV  Required.
  id: cpx_vcf
  inputBinding:
    position: 0
    prefix: --cpx-vcf
...
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: prefix for two files containing derived simple variants for complex variants
    having one/multiple entry in SEGMENT annotation  Required.
  id: prefix_out_vcf
  inputBinding:
    position: 0
