...
cwlVersion: v1.0
id: gatk_CollectBaseDistributionByCycle
inputs:
- doc: picard.jar
  id: jar
  inputBinding:
    ...
    prefix: -jar
  type: boolean?
- doc: A file (with .pdf extension) to write the chart to.  Required.
  id: CHART_OUTPUT
  inputBinding:
    position: 0
    prefix: --CHART_OUTPUT
...
- doc: to write the output to.  Required.
  ...
  inputBinding:
    ...
    prefix: --OUTPUT
  type: File
- doc: 'If set to true, calculate the base distribution over aligned reads only.  Default
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'If set to true, calculate the base distribution over PF reads only (Illumina
    specific). PF reads are reads that passed the internal quality filters applied
    by Illumina sequencers. Default value: false. Possible values: {true, false}'
  id: PF_READS_ONLY
  inputBinding:
    position: 0
