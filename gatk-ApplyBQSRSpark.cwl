...
cwlVersion: v1.0
id: gatk_ApplyBQSRSpark
inputs:
- doc: :StringInput covariates table file for base quality score recalibration  Required.
  id: bqsr_recal_file
  inputBinding:
    position: 0
...
- doc: 'when writing a bam, in single sharded mode this directory to write the temporary
  ...
  type: string?
- doc: "Don't recalibrate bases with quality scores less than this threshold  Default\
    \ value: 6."
...
- doc: ''
  ...
  type: int
- doc: ')  This argument may be specified 0 or more times. Default value: null.  Cannot
    be used in conjuction with argument(s) quantizationLevels'
  id: bqsr
  inputBinding:
    position: 0
    prefix: -bqsr
