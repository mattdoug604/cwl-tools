...
cwlVersion: v1.0
doc: '>-Usage:   samtools view [options] <in.bam>|<in.sam> [region1 [...]]'
id: samtools_view
inputs:
- doc: output BAM
  id: b
...
- doc: longer help
  ...
  inputBinding:
    ...
    prefix: -?
  type: boolean?
- doc: "' is applied, the input file is assumed to be in the SAM format. The fields\
    \ of each line consisting of the reference name and the corresponding sequence\
    \ length. The `.fai' file generated by `faidx' can be used here. This file may\
    \ be empty if reads are unaligned."
  id: t
  inputBinding:
    position: 0
    prefix: -t
  type: boolean?
- doc: ref.fa in.sam.gz'.
  id: bT
  inputBinding:
    position: 0
    prefix: -bT
