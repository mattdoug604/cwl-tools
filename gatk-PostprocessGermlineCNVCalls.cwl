...
inputs:
- doc: of paths to GermlineCNVCaller call directories.  This argument must be specified
...
- doc: Path to contig-ploidy calls directory (output of DetermineGermlineContigPloidy).
  ...
  type: File
- doc: of paths to GermlineCNVCaller model directories.  This argument must be specified
    at least once. Required.
  id: model_shard_path
  inputBinding:
    position: 0
  ...
  type: File
- doc: Output intervals VCF file.  Required.
...
- doc: 'If true, adds a command line header line to created VCF files.  Default value:
  ...
  type: boolean?
- doc: 'Contigs to treat as allosomal (i.e. choose their reference copy-number allele
    according to the sample karyotype).  This argument may be specified 0 or more
    times. Default value: .'
  id: allosomal_contig
  inputBinding:
    position: 0
...
- doc: 'read one or more arguments files and add them to the command line  This argument
  ...
  type: File?
- doc: 'Reference copy-number on autosomal intervals.  Default value: 2.'
...
- doc: 'Lenient processing of VCF files  Default value: false. Possible values: {true,
  ...
  inputBinding:
    ...
    prefix: --lenient
  type: boolean?
- doc: 'Output segments VCF file.  Default value: null.'
...
- doc: 'Reference sequence  Default value: null.'
  ...
  inputBinding:
    ...
    prefix: --reference
  type: string?
- doc: 'Sample index in the call-set (must be contained in all shards).  Default value:
    0.'
  id: sample_index
  inputBinding:
    position: 0
