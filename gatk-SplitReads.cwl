...
- doc: "If true, don't emit genotype fields when writing vcf file output.  Default\
  ...
  type: boolean?
- doc: 'Split file by library.  Default value: false. Possible values: {true, false}'
  id: split_library_name
  inputBinding:
    position: 0
    prefix: --split-library-name
  type: boolean?
- doc: ':BooleanSplit file by read group.  Default value: false. Possible values:
    {true, false}'
  id: split_read_group
  inputBinding:
    position: 0
  ...
  type: boolean?
- doc: 'Split file by sample.  Default value: false. Possible values: {true, false}'
  id: split_sample
  inputBinding:
    position: 0
    prefix: --split-sample
