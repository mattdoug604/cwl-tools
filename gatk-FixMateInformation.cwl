...
cwlVersion: v1.0
id: gatk_FixMateInformation
inputs:
- doc: picard.jar FixMateInformation \
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: The input files to check and fix. Multiple files will be merged and sorted.  This
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: ':BooleanIf true, ignore missing mates, otherwise will throw an exception when
    missing mates are found.  Default value: true. Possible values: {true, false}'
...
- doc: 'The output file to write to. If no output file is supplied, the input file
    is overwritten (only available with single input file).  Default value: null.'
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: ':SortOrder    Optional sort order if the OUTPUT file should be sorted differently
    than the INPUT file. Default value: null. Possible values: {unsorted, queryname,
