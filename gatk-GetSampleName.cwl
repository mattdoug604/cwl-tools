...
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: Output file with only the sample name in it.  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'Whether to use the JdkInflater (as opposed to IntelInflater)  Default value:
  ...
  type: boolean?
- doc: 'Apply URL encoding to convert spaces and other special characters in sample
    name.  Default value: false. Possible values: {true, false}'
  id: use_url_encoding
  inputBinding:
    position: 0
