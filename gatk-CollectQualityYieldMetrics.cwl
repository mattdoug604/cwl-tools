...
cwlVersion: v1.0
id: gatk_CollectQualityYieldMetrics
inputs:
- doc: ''
  id: jar
  inputBinding:
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'If true, include bases from secondary alignments in metrics. Setting to true
    may cause -counting of bases if there are secondary alignments in the input file.  Default
    value: false. Possible values: {true, false}'
  ...
  type: boolean?
- doc: 'If true, include bases from supplemental alignments in metrics. Setting to
    true may cause -counting of bases if there are supplemental alignments in the
    input file.  Default value: false. Possible values: {true, false}'
...
- doc: 'Use the JDK Inflater instead of the Intel Inflater for reading compressed
  ...
  type: boolean?
- doc: 'If available in the OQ tag, use the original quality scores as inputs instead
    of the quality scores in the QUAL field.  Default value: true. Possible values:
    {true, false}'
