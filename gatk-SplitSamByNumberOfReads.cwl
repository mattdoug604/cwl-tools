...
cwlVersion: v1.0
id: gatk_SplitSamByNumberOfReads
inputs:
- doc: ''
  id: jar
  inputBinding:
    ...
    prefix: -jar
  type: boolean
- doc: Input SAM/BAM file to split  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: in which to output the split BAM files.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'Output files will be named <OUT_PREFIX>_N.bam, where N enumerates the output
    file. Default value: shard.'
  id: OUT_PREFIX
  inputBinding:
    position: 0
    prefix: --OUT_PREFIX
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: 'Split to N files.  Default value: 0.  Cannot be used in conjuction with argument(s)
  ...
  type: int?
- doc: 'Split to have approximately N reads per output file. The actual number of
    reads per output will vary by no more than the number of output files * (the maximum
    number of reads with the same queryname - 1).  Default value: 0.  Cannot be used
    in conjuction with argument(s) SPLIT_TO_N_FILES (N_FILES) SPLIT_TO_N_FILES (N_FILES)'
  id: SPLIT_TO_N_READS
  inputBinding:
    position: 0
...
- doc: 'One or more directories with space available to be used by this program for
  ...
  inputBinding:
    ...
    prefix: --TMP_DIR
  type: null?
- doc: 'Total number of reads in the input file. If this is not provided, the input
    will be read twice, the first time to get a count of the total reads.  Default
    value: 0.'
