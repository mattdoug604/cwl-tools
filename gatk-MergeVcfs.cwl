...
id: gatk_MergeVcfs
inputs:
- doc: picard.jar MergeVcfs \
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: VCF or BCF input files (File format is determined by file extension), or a
    file having a ' suffix containing the path to the files, one per line.  This argument
  ...
  inputBinding:
    ...
    prefix: --INPUT
  type: array
- doc: The merged VCF or BCF file. File format is determined by file extension.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'The index sequence dictionary to use instead of the sequence dictionary in
    the input files Default value: null.'
