...
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: :FeatureInput    One or more databases of known polymorphic sites used to exclude
    regions around known polymorphisms from analysis.  This argument must be specified
  ...
  inputBinding:
    ...
    prefix: --known-sites
  type: boolean
- doc: The output recalibration table file to create  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'Read filters to be disabled before analysis  This argument may be specified
    0 or more times. Default value: null. Possible Values: {MappedReadFilter, MappingQualityAvailableReadFilter,
    MappingQualityNotZeroReadFilter, NotDuplicateReadFilter, NotSecondaryAlignmentReadFilter,
