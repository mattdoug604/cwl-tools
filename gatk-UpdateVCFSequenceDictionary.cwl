...
cwlVersion: v1.0
id: gatk_UpdateVCFSequenceDictionary
inputs:
- doc: to which updated variants should be written  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'Reference sequence  Default value: null.'
  ...
  inputBinding:
    ...
    prefix: --reference
  type: string?
- doc: 'Force replacement of the dictionary if the input file already has a dictionary  Default
...
- doc: "If true, don't emit genotype fields when writing vcf file output.  Default\
  ...
  type: boolean?
- doc: 'A variant, alignment, dictionary, or reference file to use as a dictionary
    source (optional if the sequence dictionary source is specified as a reference
    argument). The dictionary presented must be valid (contain a sequence record)
    for each sequence that is referenced by any variant in the input file.  Default
    value: null.'
  id: source_dictionary
  inputBinding:
    position: 0
