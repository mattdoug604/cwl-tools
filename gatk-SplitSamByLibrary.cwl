...
- doc: picard.jar
  ...
  inputBinding:
    ...
    prefix: -jar
  type: boolean?
- doc: The SAM or BAM file to be split.   Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'The directory where the library SAM or BAM files should be written (defaults
    to the current directory).   Default value: /home/mdouglas/git/autogen-cwl-tool/tests/..'
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
