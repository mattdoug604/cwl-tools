...
cwlVersion: v1.0
id: gatk_ClusterCrosscheckMetrics
inputs:
- doc: picard.jar ClusterCrosscheckMetrics \
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: The cross-check metrics file to be clustered.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'LOD score to be used as the threshold for clustering.  Default value: 0.0.'
  id: LOD_THRESHOLD
  inputBinding:
    position: 0
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'Output file to write metrics to. Will write to stdout if null.  Default value:
    null.'
  id: OUTPUT
  inputBinding:
    position: 0
