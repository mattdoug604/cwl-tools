...
cwlVersion: v1.0
id: gatk_ValidateBasicSomaticShortMutations
inputs:
- doc: :Stringsample name for discovery in VCF.  Required.
  id: discovery_sample_name
  inputBinding:
    position: 0
    prefix: --discovery-sample-name
  type: boolean
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: The output file, which will be a validation table (tsv).  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: Reference sequence file  Required.
  ...
  inputBinding:
    ...
    prefix: --reference
  type: string
- doc: validation case sample name (in the bam)  Required.
  id: val_case_sample_name
  inputBinding:
    position: 0
    prefix: --val-case-sample-name
  type: string
- doc: validation control sample name (in the bam)  Required.
  id: val_control_sample_name
  inputBinding:
    position: 0
    prefix: --val-control-sample-name
  type: string
...
- doc: 'If true, adds a command line header line to created VCF files.  Default value:
  ...
  type: boolean?
- doc: 'Optional output vcf containing original variants annotated with validation
...
- doc: 'Read filters to be disabled before analysis  This argument may be specified
    0 or more times. Default value: null. Possible Values: {MappingQualityNotZeroReadFilter,
    NotDuplicateReadFilter, PassesVendorQualityCheckReadFilter, WellformedReadFilter}'
...
- doc: 'Lenient processing of VCF files  Default value: false. Possible values: {true,
  ...
  inputBinding:
    ...
    prefix: --lenient
  type: boolean?
- doc: 'minimum base quality to count a read toward validation.  Default value: 20.'
  id: min_base_quality_cutoff
  inputBinding:
    position: 0
    prefix: --min-base-quality-cutoff
  type: int?
- doc: 'Minimum power for an unvalidated variant to be considered a false positive.  Default
    value: 0.9.'
  id: min_power
  inputBinding:
    position: 0
...
- doc: "If true, don't emit genotype fields when writing vcf file output.  Default\
  ...
  type: boolean?
- doc: 'A table of summary statistics (true positives, sensitivity, etc.)  Default
    value: null.'
  id: summary
  inputBinding:
    position: 0
