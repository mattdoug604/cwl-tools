...
- doc: One or more genomic intervals over which to operate  This argument must be
  ...
  inputBinding:
    ...
    prefix: --intervals
  type: string
- doc: Output file for allelic counts.  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'Read filters to be disabled before analysis  This argument may be specified
    0 or more times. Default value: null. Possible Values: {MappedReadFilter, MappingQualityReadFilter,
    NonZeroReferenceLengthAlignmentReadFilter, NotDuplicateReadFilter, WellformedReadFilter}'
...
- doc: 'Maximum number of reads to retain per sample per locus. Reads above this threshold
  ...
  type: int?
- doc: ':IntegerMinimum base quality.  Base calls with lower quality will be filtered
    out of pileups. Default value: 20.'
...
- doc: 'Maximum mapping quality to keep (inclusive)  Default value: null.'
  ...
  type: int?
- doc: 'Minimum mapping quality to keep (inclusive)  Default value: 30.'
