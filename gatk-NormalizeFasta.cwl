...
cwlVersion: v1.0
id: gatk_NormalizeFasta
inputs:
- doc: picard.jar NormalizeFasta \<br />      I=input_sequence.fasta
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: The input FASTA file to normalize.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: The output FASTA file to write.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'One or more directories with space available to be used by this program for
  ...
  inputBinding:
    ...
    prefix: --TMP_DIR
  type: null?
- doc: 'Truncate sequence names at first whitespace.  Default value: false. Possible
    values: {true, false}'
