...
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: The output directory to which the scattered output will be written.  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'Maximum number of reads to retain per sample per locus. Reads above this threshold
    will be downsampled. Set to 0 to disable.  Default value: 0.'
  id: maxDepthPerSample
  inputBinding:
    position: 0
    prefix: --maxDepthPerSample
  type: int?
- doc: ':FeatureInput Features file(s) containing metadata. The overlapping sites
    will be annotated with the corresponding source Feature identifier.  This argument
    may be specified 0 or more times. Default value: null.'
  id: metadata
  inputBinding:
    position: 0
...
- doc: 'For tools that shuffle data or write an output, sets the number of reducers.
  ...
  inputBinding:
    ...
    prefix: --num-reducers
  type: int?
- doc: 'If enabled, inserts lengths will be added to the output pileup.  Default value:
...
- doc: ':ValidationStringency Validation stringency for all SAM/BAM/CRAM/SRA files
  ...
  type: string?
- doc: 'Maximum size of each read shard, in bases.  Default value: 10000.'
  id: readShardSize
  inputBinding:
    position: 0
...
- doc: 'For tools that write an output, write the output in multiple pieces (shards)  Default
  ...
  type: boolean?
- doc: "Add extra informative columns to the pileup output. The verbose output contains\
    \ the number of spanning deletions, and for each read in the pileup it has the\
    \ read name, offset in the base string, read length, and read mapping quality.\
    \  These per read items are delimited with an '@' character.  Default value: false.\
    \ Possible values: {true, false}"
  id: show_verbose
  inputBinding:
    position: 0
    prefix: --show-verbose
  type: boolean?
- doc: 'whether to use the shuffle implementation or overlaps partitioning (the default)  Default
