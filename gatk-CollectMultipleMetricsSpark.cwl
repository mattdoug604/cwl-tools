...
cwlVersion: v1.0
id: gatk_CollectMultipleMetricsSpark
inputs:
...
- doc: 'maximum number of bytes to read from a file into each partition of reads.
  ...
  type: long?
- doc: ':SparkCollectors  List of metrics collectors to apply during the pass through
    the SAM file. If no collectors are specified than all collectors will be run  This
    argument may be specified 0 or more times. Default value: null. Possible values:
    {CollectInsertSizeMetrics, CollectQualityYieldMetrics}'
  id: collectors
  inputBinding:
    position: 0
    prefix: --collectors
