...
cwlVersion: v1.0
id: gatk_ParallelCopyGCSDirectoryIntoHDFSSpark
inputs:
- doc: input GCS file path (add trailing slash when specifying a directory)  Required.
  id: input_gcs_path
  inputBinding:
    position: 0
    prefix: --input-gcs-path
  type: string
- doc: :Stringoutput directory on HDFS to into which to transfer the data (will be
    created by the tool) Required.
  id: output_hdfs_directory
  inputBinding:
    position: 0
    prefix: --output-hdfs-directory
  type: Directory
...
- doc: 'BAM/SAM/CRAM file containing reads  This argument may be specified 0 or more
  ...
  inputBinding:
    ...
    prefix: --input
  type: string?
- doc: 'optional wildcard glob to subset files in the input directory to copy  Default
    value: *.'
  id: input_file_glob
  inputBinding:
    position: 0
    prefix: --input-file-glob
  type: string?
