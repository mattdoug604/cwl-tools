...
cwlVersion: v1.0
id: gatk_ExtractSequences
inputs:
- doc: picard.jar ExtractSequences \<br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: Interval list describing intervals to be extracted from the reference sequence.  Required.
  id: INTERVAL_LIST
  inputBinding:
    position: 0
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'Maximum line length for sequence data.  Default value: 80.'
  id: LINE_LENGTH
  inputBinding:
    position: 0
    prefix: --LINE_LENGTH
