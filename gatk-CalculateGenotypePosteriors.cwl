...
- doc: 'If true, create a a MD5 digest any VCF file created.  Default value: false.
  ...
  type: boolean?
- doc: 'Prior for de novo mutations  Default value: 1.0E-6.'
  id: de_novo_prior
  inputBinding:
    position: 0
    prefix: --de-novo-prior
  type: double?
- doc: 'Use AC rather than MLEAC  Default value: false. Possible values: {true, false}'
  id: default_to_allele_count
  inputBinding:
    position: 0
    prefix: --default-to-allele-count
  type: boolean?
...
- doc: 'Do not use discovered allele count in the input callset for variants that
    do not appear in the external callset.   Default value: false. Possible values:
    {true, false}'
  id: discovered_allele_count_priors_off
  inputBinding:
    position: 0
    prefix: --discovered-allele-count-priors-off
  type: boolean?
...
- doc: 'Project to bill when accessing "requester pays" buckets. If unset, these buckets
  ...
  type: string?
- doc: 'Global Dirichlet prior parameters for the indel allele frequency  Default
    value: 0.001.'
  id: global_prior_indel
  inputBinding:
    position: 0
    prefix: --global-prior-indel
  type: double?
- doc: 'Global Dirichlet prior parameters for the SNP allele frequency  Default value:
    0.001.'
  id: global_prior_snp
  inputBinding:
    position: 0
    prefix: --global-prior-snp
  type: double?
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: ':BooleanUse external information only  Default value: false. Possible values:
    {true, false}'
  id: ignore_input_samples
  inputBinding:
    position: 0
    prefix: --ignore-input-samples
  type: boolean?
...
- doc: 'Number of hom-ref genotypes to infer at sites not present in a panel  Default
  ...
  type: int?
- doc: 'Pedigree file for samples  Default value: null.'
  id: pedigree
  inputBinding:
    position: 0
    prefix: --pedigree
...
- doc: "If true, don't emit genotype fields when writing vcf file output.  Default\
  ...
  type: boolean?
- doc: 'Skip application of family-based priors  Default value: false. Possible values:
    {true, false}'
  id: skip_family_priors
  inputBinding:
    position: 0
    prefix: --skip-family-priors
  type: boolean?
- doc: 'Skip application of population-based priors  Default value: false. Possible
    values: {true, false}'
  id: skip_population_priors
  inputBinding:
    position: 0
    prefix: --skip-population-priors
  type: boolean?
- doc: ':FeatureInput Other callsets to use in generating genotype posteriors  This
    argument may be specified 0 or more times. Default value: null.'
  id: supporting_callsets
  inputBinding:
    position: 0
    prefix: --supporting-callsets
  type: boolean?
- doc: 'Temp directory to use.  Default value: null.'
  ...
  inputBinding:
    ...
    prefix: --tmp-dir
  type: string?
- doc: 'Use flat priors for indels  Default value: false. Possible values: {true,
    false}'
  id: use_flat_priors_for_indels
  inputBinding:
    position: 0
    prefix: --use-flat-priors-for-indels
  type: boolean?
