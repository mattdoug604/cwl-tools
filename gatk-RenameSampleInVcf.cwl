...
cwlVersion: v1.0
id: gatk_RenameSampleInVcf
inputs:
- doc: picard.jar RenameSampleInVcf \<br />      INPUT=input_variants.vcf \<br />      OUTPUT=output_variants.vcf
    \<br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: Input single sample VCF or BCF file.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: New name to give sample in output VCF.  Required.
  id: NEW_SAMPLE_NAME
  inputBinding:
    position: 0
    prefix: --NEW_SAMPLE_NAME
  type: string
- doc: Output single sample VCF.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'Existing name of sample in VCF; if provided, asserts that that is the name
    of the extant sample name  Default value: null.'
  id: OLD_SAMPLE_NAME
  inputBinding:
    position: 0
