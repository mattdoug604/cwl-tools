...
cwlVersion: v1.0
id: gatk_CollectBaseDistributionByCycleSpark
inputs:
- doc: 'If true, adds a command line header line to created VCF files.  Default value:
  ...
  type: boolean?
- doc: 'If set to true, calculates the base distribution over aligned reads only.  Default
...
- doc: 'maximum number of bytes to read from a file into each partition of reads.
  ...
  type: long?
- doc: 'Output charts file (pdf).  Default value: null.'
  id: chart
  inputBinding:
    position: 0
    prefix: --chart
...
- doc: 'For tools that shuffle data or write an output, sets the number of reducers.
  ...
  inputBinding:
    ...
    prefix: --num-reducers
  type: int?
- doc: 'Output metrics file.  Default value: null.'
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'when writing a bam, in single sharded mode this directory to write the temporary
  ...
  type: string?
- doc: 'If set to true, calculates the base distribution over passing filter (PF)
    reads only. Default value: false. Possible values: {true, false}'
  id: pf_reads_only
  inputBinding:
    position: 0
