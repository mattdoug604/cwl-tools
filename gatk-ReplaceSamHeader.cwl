...
cwlVersion: v1.0
id: gatk_ReplaceSamHeader
inputs:
- doc: picard.jar ReplaceSamHeader \<br />      I=input_1.bam \<br />      HEADER=input_2.bam
    \<br
  id: jar
  inputBinding:
    position: 0
...
- doc: SAM file from which SAMFileHeader will be read.  Required.
  ...
  inputBinding:
    ...
    prefix: --HEADER
  type: File
- doc: SAM file from which SAMRecords will be read.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: SAMFileHeader from HEADER file will be written to this file, followed by SAMRecords
    from INPUT file  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
