...
id: gatk_SortVcf
inputs:
- doc: picard.jar SortVcf \<br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: Input VCF(s) to be sorted. Multiple inputs must have the same sample names
    (in order) This argument must be specified at least once. Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: Output VCF to be written.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: ':FileUndocumented option  Default value: null.'
