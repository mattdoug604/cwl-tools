...
cwlVersion: v1.0
id: gatk_CollectIlluminaLaneMetrics
inputs:
- doc: ''
  id: jar
  inputBinding:
...
- doc: The directory to which the output file will be written  Required.
  ...
  type: File
- doc: The prefix to be prepended to the file name of the output file; an appropriate
    suffix will be applied  Required.
  id: OUTPUT_PREFIX
  inputBinding:
    position: 0
    prefix: --OUTPUT_PREFIX
  type: string
- doc: The Illumina run directory of the run for which the lane metrics are to be
    generated Required.
  id: RUN_DIRECTORY
  inputBinding:
    position: 0
...
- doc: 'Whether to create an MD5 digest for any BAM or FASTQ files created.    Default
  ...
  type: boolean?
- doc: 'Append the given file extension to all metric file names (ex. OUTPUT.illumina_lane_metrics.EXT).
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'the determines if this run is a NovaSeq run or not. (NovaSeq tile metrics
    files are in cycle 25 directory.  Default value: false. Possible values: {true,
    false}'
  id: IS_NOVASEQ
  inputBinding:
    position: 0
...
- doc: 'Whether to suppress job-summary info on System.err.  Default value: false.
  ...
  inputBinding:
    ...
    prefix: --QUIET
  type: boolean?
- doc: ':ReadStructure A description of the logical structure of clusters in an Illumina
    Run, i.e. a description of the structure IlluminaBasecallsToSam assumes the  data
    to be in. It should consist of /character pairs describing the number of cycles
    and the type of those cycles (B for Sample Barcode, M for molecular barcode, T
    for Template, and S for skip).  E.g. If the input data consists of 80 base clusters
    ...
    an output SAM/BAM file or in read groups therein. If not given, will use the RunInfo.xml
