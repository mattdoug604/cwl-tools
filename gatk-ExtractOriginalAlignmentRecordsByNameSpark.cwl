...
cwlVersion: v1.0
id: gatk_ExtractOriginalAlignmentRecordsByNameSpark
inputs:
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: to write reads to  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
  type: string
- doc: containing list of read names  Required.
  id: read_name_file
  inputBinding:
    position: 0
    prefix: --read-name-file
  type: string
...
- doc: 'One or more genomic intervals over which to operate  This argument may be
  ...
  inputBinding:
    ...
    prefix: --intervals
  type: string?
- doc: 'invert the list, i.e. filter out reads whose name appear in the given file  Default
