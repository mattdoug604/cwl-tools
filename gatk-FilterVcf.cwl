...
id: gatk_FilterVcf
inputs:
- doc: The INPUT VCF or BCF file.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: The output VCF or BCF.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: "Filters a VCF file with a javascript expression interpreted by the java javascript\
    \ engine. The script puts the following variables in the script context:  'variant'\
    \ a VariantContext ( https://samtools.github.io/htsjdk/javadoc/htsjdk/htsjdk/variant/variantcontext/VariantContext.html\
    \ ) and  'header' a VCFHeader ( https://samtools.github.io/htsjdk/javadoc/htsjdk/htsjdk/variant/vcf/VCFHeader.html\
    \ ). Last value of the script should be a boolean to tell whether we should accept\
    \ or reject the .  Default value: null."
  id: JAVASCRIPT_FILE
  inputBinding:
    position: 0
    prefix: --JAVASCRIPT_FILE
  type: record?
- doc: 'The maximum phred scaled fisher strand value before a site will be filtered
    out.  Default value: 1.7976931348623157E308.'
  id: MAX_FS
  inputBinding:
    position: 0
    prefix: --MAX_FS
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'The minimum allele balance acceptable before filtering a site. Allele balance
    is calculated for heterozygotes as the number of bases supporting the least-represented
    allele over the total number of base observations. Different heterozygote genotypes
    at the same locus are measured independently. The locus is filtered if any allele
    balance is below the limit.  Default value: 0.0.'
  id: MIN_AB
  inputBinding:
    position: 0
    prefix: --MIN_AB
  type: double?
- doc: 'The minimum sequencing depth supporting a genotype before the genotype will
    be filtered out.  Default value: 0.'
  id: MIN_DP
  inputBinding:
    position: 0
    prefix: --MIN_DP
  type: int?
- doc: 'The minimum genotype quality that must be achieved for a sample otherwise
    the genotype will be filtered out.  Default value: 0.'
  id: MIN_GQ
  inputBinding:
    position: 0
    prefix: --MIN_GQ
  type: int?
- doc: 'The minimum QD value to accept or otherwise filter out the variant.  Default
    value: 0.0.'
  id: MIN_QD
  inputBinding:
    position: 0
