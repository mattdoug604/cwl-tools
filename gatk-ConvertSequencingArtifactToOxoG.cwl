...
cwlVersion: v1.0
id: gatk_ConvertSequencingArtifactToOxoG
inputs:
- doc: picard.jar ConvertSequencingArtifactToOxoG
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'Basename for output OxoG metrics. Defaults to same basename as input metrics  Default
    value: null.'
  id: OUTPUT_BASE
  inputBinding:
    position: 0
