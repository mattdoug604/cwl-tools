...
cwlVersion: v1.0
id: gatk_MakeVcfSampleNameMap
inputs:
- doc: picard.jar MakeVcfSampleNameMap \
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: One or more input VCFs to extract sample names from.  This argument must be
  ...
  inputBinding:
    ...
    prefix: --INPUT
  type: string
- doc: Output file to write the sample-name map to.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
