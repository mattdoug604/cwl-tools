...
inputs:
- doc: picard.jar MakeSitesOnlyVcf \ <br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: Input VCF or BCF containing genotype and site-level information.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: Output VCF or BCF file containing only site-level information.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: 'Names of one or more samples to include in the output VCF.  This argument
    may be specified 0 or more times. Default value: null.'
  id: SAMPLE
  inputBinding:
    position: 0
