...
cwlVersion: v1.0
id: gatk_AccumulateVariantCallingMetrics
inputs:
- doc: Paths (except for the file extensions) of Variant Calling Metrics files to
    read and merge. This argument must be specified at least once. Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
