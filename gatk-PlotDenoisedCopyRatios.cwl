...
inputs:
- doc: Input file containing denoised copy ratios (output of DenoiseReadCounts).  Required.
...
- doc: containing a sequence dictionary, which specifies the contigs to be plotted
  ...
  type: File
- doc: Input file containing standardized copy ratios (output of DenoiseReadCounts).  Required.
