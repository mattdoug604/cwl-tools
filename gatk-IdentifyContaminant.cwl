...
cwlVersion: v1.0
id: gatk_IdentifyContaminant
inputs:
- doc: A file of haplotype information. The file lists a set of SNPs, optionally arranged
    in high-LD blocks, to be used for fingerprinting. See https://software.broadinstitute.org/gatk/documentation/article?id=9526
...
- doc: Input SAM or BAM file.  Required.
  ...
  inputBinding:
    ...
    prefix: --INPUT
  type: File
- doc: Output fingerprint file (VCF).  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'Compression level for all compressed files created (e.g. BAM and VCF).  Default
  ...
  type: int?
- doc: 'A value of estimated contamination in the input.   Default value: 0.0.'
  id: CONTAMINATION
  inputBinding:
    position: 0
...
- doc: 'Whether to create an MD5 digest for any BAM or FASTQ files created.    Default
  ...
  type: boolean?
- doc: :BooleanExtract a fingerprint for the contaminated sample (instead of the contaminant).
    Setting to true changes the effect of SAMPLE_ALIAS when null. It names the sample
    in the VCF
  ...
  type: boolean?
- doc: ', using the SM value from the SAM header.  Default value: false. Possible
    values: {true, false}'
  id: contaminated
  inputBinding:
    position: 0
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'The maximum number of reads to use as evidence for any given locus. This is
    provided as a way to limit the effect that any given locus may have.  Default
    value: 200.'
  id: LOCUS_MAX_READS
  inputBinding:
    position: 0
...
- doc: 'Whether to suppress job-summary info on System.err.  Default value: false.
  ...
  inputBinding:
    ...
    prefix: --QUIET
  type: boolean?
- doc: The sample alias to associate with the resulting fingerprint. When null, <SAMPLE>
    is
  id: SAMPLE_ALIAS
  inputBinding:
    position: 0
    prefix: --SAMPLE_ALIAS
  type: string?
- doc: '" is used.  Default value: null.'
  id: contamination
  inputBinding:
    position: 0
    prefix: -contamination
