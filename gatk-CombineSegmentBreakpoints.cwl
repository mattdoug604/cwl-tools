...
cwlVersion: v1.0
id: gatk_CombineSegmentBreakpoints
inputs:
- doc: of columns in either segment file that should be reported in the output file.  If
    the column header exists in both, it will have the appropriate label appended
    as a suffix. This argument must be specified at least once. Required.
  id: columns_of_interest
  inputBinding:
    position: 0
    prefix: --columns-of-interest
  type: array
- doc: Output TSV file with combined segment breakpoints  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
  type: File
- doc: must be specified twice, but order does not matter.  This argument must be
...
- doc: 'One or more genomic intervals over which to operate  This argument may be
  ...
  inputBinding:
    ...
    prefix: --intervals
  type: string?
- doc: 'these will appear as suffixes in case of collisions.  The specification order
    must correspond to the input segment files.  This argument may be specified 0
    or more times. Default value: [1, 2].'
  id: labels
  inputBinding:
    position: 0
    prefix: --labels
