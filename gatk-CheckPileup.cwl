...
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: :FeatureInput         Pileup generated by Samtools  Required.
  id: pileup
  inputBinding:
    position: 0
    prefix: --pileup
...
- doc: 'Size of the cloud-only prefetch buffer (in MB; 0 to disable).  Default value:
  ...
  type: int?
- doc: ':BooleanContinue after encountering an error  Default value: false. Possible
    values: {true, false}'
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'Disable read-pair overlap detection  Default value: false. Possible values:
    {true, false}'
  id: ignore_overlaps
  inputBinding:
    position: 0
