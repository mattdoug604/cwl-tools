...
cwlVersion: v1.0
id: gatk_IntervalListToBed
inputs:
- doc: Input IntervalList file.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: Output BED file.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: 'The score, between 0-1000, to output for each interval in the BED file.  Default
    value: 500.'
  id: SCORE
  inputBinding:
    position: 0
    prefix: --SCORE
  type: int?
- doc: 'If true, sort the interval list prior to outputting as BED file.  Default
