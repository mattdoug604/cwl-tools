...
cwlVersion: v1.0
id: gatk_FilterFuncotations
inputs:
- doc: Output VCF file to which filtered variants should be written.  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
  type: File
- doc: ':Reference       The version of the Human Genome reference which was used
    to Funcotate the input VCF. Required. Possible values: {b37, hg19, hg38}'
  id: ref_version
  inputBinding:
    position: 0
    prefix: --ref-version
