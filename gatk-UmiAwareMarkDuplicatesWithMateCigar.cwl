...
cwlVersion: v1.0
id: gatk_UmiAwareMarkDuplicatesWithMateCigar
inputs:
- doc: picard.jar
  id: jar
  inputBinding:
...
- doc: 'Add PG tag to each read in a SAM or BAM  Default value: true. Possible values:
  ...
  type: boolean?
- doc: "FOR TESTING ONLY: allow for missing UMIs if data doesn't have UMIs. This option\
    \ is intended to be used ONLY for testing the code. Use MarkDuplicatesWithMateCigar\
    \ if data has no UMIs. Mixed data (where some reads have UMIs and others do not)\
    \ is not supported. Default value: false. Possible values: {true, false}"
...
- doc: 'read one or more arguments files and add them to the command line  This argument
  ...
  type: File?
- doc: 'Tag name to use for assigned UMI  Default value: MI.'
  id: ASSIGNED_UMI_TAG
  inputBinding:
    position: 0
    prefix: --ASSIGNED_UMI_TAG
  type: string?
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'Largest edit distance that UMIs must have in order to be considered as coming
    from distinct source molecules.  Default value: 1.'
...
- doc: 'Value of CL tag of PG record to be created. If not supplied the command line
  ...
  type: string?
- doc: 'Value of PN tag of PG record to be created.  Default value: UmiAwareMarkDuplicatesWithMateCigar.'
...
- doc: 'One or more directories with space available to be used by this program for
  ...
  inputBinding:
    ...
    prefix: --TMP_DIR
  type: null?
- doc: 'Tag name to use for UMI  Default value: RX.'
  id: UMI_TAG_NAME
  inputBinding:
    position: 0
    prefix: --UMI_TAG_NAME
