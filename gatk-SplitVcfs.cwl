...
id: gatk_SplitVcfs
inputs:
- doc: picard.jar SplitVcfs \<br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: The VCF or BCF file to which indel records should be written. The file format
    is determined by file extension.  Required.
  id: INDEL_OUTPUT
  inputBinding:
    position: 0
    prefix: --INDEL_OUTPUT
  type: File
- doc: The VCF or BCF input file  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: The VCF or BCF file to which SNP records should be written. The file format
    is determined by file extension.  Required.
  id: SNP_OUTPUT
  inputBinding:
    position: 0
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: 'The index sequence dictionary to use instead of the sequence dictionaries
    in the input files  Default value: null.'
  id: SEQUENCE_DICTIONARY
  inputBinding:
    position: 0
    prefix: --SEQUENCE_DICTIONARY
  type: File?
- doc: 'If true an exception will be thrown if an event type other than SNP or indel
    is encountered  Default value: true. Possible values: {true, false}'
  id: STRICT
  inputBinding:
    position: 0
    prefix: --STRICT
