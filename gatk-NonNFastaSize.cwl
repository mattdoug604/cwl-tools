...
cwlVersion: v1.0
id: gatk_NonNFastaSize
inputs:
- doc: picard.jar NonNFastaSize \<br />      I=input_sequence.fasta \<br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
...
- doc: The input FASTA file.  Required.
  ...
  inputBinding:
    ...
    prefix: --INPUT
  type: File
- doc: The output file in which to record the count.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'An interval list file that contains the locations of the positions to assess.  If
    not provided, the entire reference will be used  Default value: null.'
  id: INTERVALS
  inputBinding:
    position: 0
    prefix: --INTERVALS
