...
inputs:
- doc: The directory into which to write the scattered interval sub-directories.  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'Reference sequence  Default value: null.'
  ...
  inputBinding:
    ...
    prefix: --reference
  type: string?
- doc: 'scatter count: number of output interval files to split into  Default value:
    1.'
  id: scatter_count
  inputBinding:
    position: 0
...
- doc: "If true, don't emit genotype fields when writing vcf file output.  Default\
  ...
  type: boolean?
- doc: ':Mode How to divide intervals.  Default value: INTERVAL_SUBDIVISION. Possible
    values: {INTERVAL_SUBDIVISION, BALANCING_WITHOUT_INTERVAL_SUBDIVISION, BALANCING_WITHOUT_INTERVAL_SUBDIVISION_WITH_OVERFLOW}'
  id: subdivision_mode
  inputBinding:
    position: 0
