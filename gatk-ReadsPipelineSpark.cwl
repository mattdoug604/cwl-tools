...
- doc: 'If true, adds a command line header line to created VCF files.  Default value:
  ...
  type: boolean?
- doc: 'whether to perform alignment using BWA-MEM  Default value: false. Possible
    values: {true, false}'
  id: align
  inputBinding:
    position: 0
...
- doc: 'BQSR BAQ gap open penalty (Phred Scaled).  Default value is 40.  30 is perhaps
  ...
  type: double?
- doc: "The BWA-MEM index image file name that you've distributed to each executor\
    \  Default value: ."
...
- doc: 'Number of hom-ref genotypes to infer at sites not present in a panel  Default
  ...
  type: int?
- doc: 'the output bam  Default value: null.'
  id: output_bam
  inputBinding:
    position: 0
    prefix: --output-bam
...
- doc: 'For tools that write an output, write the output in multiple pieces (shards)  Default
  ...
  type: boolean?
- doc: 'Run single-end instead of paired-end alignment  Default value: false. Possible
    values: {true, false}'
  id: single_end_alignment
  inputBinding:
    position: 0
