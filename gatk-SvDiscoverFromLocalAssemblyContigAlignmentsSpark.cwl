...
cwlVersion: v1.0
id: gatk_SvDiscoverFromLocalAssemblyContigAlignmentsSpark
inputs:
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: prefix for output files (including VCF files and if enabled, the signaling
    assembly contig's alignments); sample name will be appended after the provided
    argument  Required.
  id: output
  inputBinding:
    position: 0
...
- doc: 'read one or more arguments files and add them to the command line  This argument
  ...
  type: File?
- doc: 'Uncertainty in overlap of assembled breakpoints and evidence target links.  Default
    value: 100.'
  id: assembly_imprecise_evidence_overlap_uncertainty
  inputBinding:
    position: 0
...
- doc: 'maximum number of bytes to read from a file into each partition of reads.
  ...
  type: long?
- doc: 'External CNV calls file. Should be single sample VCF, and contain only confident
    autosomal non-reference CNV calls (for now).  Default value: null.'
  id: cnv_calls
  inputBinding:
    position: 0
    prefix: --cnv-calls
...
- doc: 'Read filters to be disabled before analysis  This argument may be specified
    0 or more times. Default value: null. Possible Values: {MappedReadFilter}'
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'Number of pieces of imprecise evidence necessary to call a variant in the
    absence of an assembled breakpoint.  Default value: 7.'
  id: imprecise_variant_evidence_threshold
  inputBinding:
    position: 0
...
- doc: 'One or more genomic intervals over which to operate  This argument may be
  ...
  inputBinding:
    ...
    prefix: --intervals
  type: string?
- doc: 'Maximum size deletion to call based on imprecise evidence without corroborating
    read depth evidence  Default value: 15000.'
  id: max_callable_imprecise_deletion_size
  inputBinding:
    position: 0
...
- doc: 'Minimum flanking alignment length  Default value: 50.'
  ...
  type: int?
- doc: 'Minimum mapping quality of evidence assembly contig  Default value: 30.'
  id: min_mq
  inputBinding:
    position: 0
    prefix: --min-mq
  type: int?
- doc: 'containing non-canonical chromosome names (e.g chrUn_KI270588v1) in the reference,
    human reference (hg19 or hg38) assumed when omitted  Default value: null.'
  id: non_canonical_contig_names_file
  inputBinding:
    position: 0
...
- doc: 'display the version number for this tool  Default value: false. Possible values:
  ...
  inputBinding:
    ...
    prefix: --version
  type: boolean?
- doc: 'output query-name sorted SAM files for local assembly contigs whose alignment
    signature could not be used for emitting un-ambiguous calls  Default value: false.
    Possible values: {true, false}'
  id: write_sam
  inputBinding:
    position: 0
    prefix: --write-sam
  type: boolean?
- doc: 'Run interpretation tool in debug mode (more information print to screen)  Default
