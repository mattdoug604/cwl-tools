...
- doc: Output VCF to be written.  Required.
  ...
  inputBinding:
    ...
    prefix: --OUTPUT
  type: File
- doc: :FileA Sequence Dictionary (can be read from one of the following file types
    (SAM, BAM, VCF, BCF, Interval List, Fasta, or Dict)  Required.
