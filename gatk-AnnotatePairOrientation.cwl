...
cwlVersion: v1.0
id: gatk_AnnotatePairOrientation
inputs:
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: Output Somatic SNP/Indel VCF file with additional annotations.  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'Lenient processing of VCF files  Default value: false. Possible values: {true,
  ...
  inputBinding:
    ...
    prefix: --lenient
  type: boolean?
- doc: 'Cutoff for the min base quality value(s) to count the read.  These are for
    bases that overlap the variant.  Default value: 7.'
