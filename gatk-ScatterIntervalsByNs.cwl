...
cwlVersion: v1.0
id: gatk_ScatterIntervalsByNs
inputs:
- doc: picard.jar ScatterIntervalsByNs \
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: Output file for interval list.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'Reference sequence to use. Note: this tool requires that the reference fasta
    has both an associated index and a dictionary.  Required.'
  id: REFERENCE
  inputBinding:
    position: 0
    prefix: --REFERENCE
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'Maximal number of contiguous N bases to tolerate, thereby continuing the current
    ACGT interval.  Default value: 1.'
  id: MAX_TO_MERGE
  inputBinding:
    position: 0
    prefix: --MAX_TO_MERGE
  type: int?
- doc: ':OutputType  Type of intervals to output.  Default value: BOTH. Possible values:
    {N, ACGT, BOTH}'
  id: OUTPUT_TYPE
  inputBinding:
    position: 0
