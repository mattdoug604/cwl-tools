...
cwlVersion: v1.0
id: gatk_CollectF1R2Counts
inputs:
- doc: a histogram of alt sites with alt depth = 1  Required.
  id: alt_hist
  inputBinding:
    position: 0
    prefix: --alt-hist
  type: File
- doc: a tab-separated output table of pileup data over alt sites  Required.
  id: alt_table
  inputBinding:
    position: 0
    prefix: --alt-table
...
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: a metrics file with overall summary metrics and reference context-specific
    depth histograms  Required.
  id: ref_hist
  inputBinding:
    position: 0
    prefix: --ref-hist
...
- doc: 'Maximum number of reads to retain per sample per locus. Reads above this threshold
  ...
  type: int?
- doc: 'skip sites with median mapping quality below this value  Default value: 30.'
  id: median_mq
  inputBinding:
    position: 0
    prefix: --median-mq
