...
inputs:
- doc: Output Picard interval-list file containing the preprocessed intervals.  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'read one or more arguments files and add them to the command line  This argument
  ...
  type: File?
- doc: 'Length (in bp) of the bins.  If zero, no binning will be performed.  Default
    value: 1000.'
  id: bin_length
  inputBinding:
    position: 0
...
- doc: 'Lenient processing of VCF files  Default value: false. Possible values: {true,
  ...
  inputBinding:
    ...
    prefix: --lenient
  type: boolean?
- doc: 'Length (in bp) of the padding regions on each side of the intervals.  Default
    value: 250.'
  id: padding
  inputBinding:
    position: 0
