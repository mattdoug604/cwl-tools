...
cwlVersion: v1.0
id: gatk_CollectInsertSizeMetricsSpark
inputs:
...
- doc: 'Read filters to be disabled before analysis  This argument may be specified
    0 or more times. Default value: null. Possible Values: {FirstOfPairReadFilter,
    MappedReadFilter, MappingQualityReadFilter, NonZeroFragmentLengthReadFilter, NotDuplicateReadFilter,
    NotSecondaryAlignmentReadFilter, NotSupplementaryAlignmentReadFilter, PairedReadFilter,
    ProperlyPairedReadFilter, WellformedReadFilter}'
...
- doc: 'One or more genomic intervals over which to operate  This argument may be
  ...
  inputBinding:
    ...
    prefix: --intervals
  type: string?
- doc: ':MetricAccumulationLevel The level(s) at which to accumulate metrics. Possible
    values are {ALL_READS, SAMPLE, LIBRARY, READ GROUP}.  This argument may be specified
    0 or more times. Default value: [ALL_READS]. Possible values: {ALL_READS, SAMPLE,
    LIBRARY, READ_GROUP}'
...
- doc: 'when writing a bam, in single sharded mode this directory to write the temporary
  ...
  type: string?
- doc: 'If enabled, an output .pdf plot will be created.  Default value: false. Possible
    values: {true, false}'
  id: produce_plot
  inputBinding:
    position: 0
...
- doc: 'Maximum mapping quality to keep (inclusive)  Default value: null.'
  ...
  type: int?
- doc: 'Minimum mapping quality to keep (inclusive)  Default value: 0.'
