...
- doc: 'read one or more arguments files and add them to the command line  This argument
  ...
  type: File?
- doc: ':ClippingRepresentation How should we actually clip the bases?  Default value:
    WRITE_NS. Possible values: {WRITE_NS, WRITE_Q0S, WRITE_NS_Q0S, SOFTCLIP_BASES,
    HARDCLIP_BASES, REVERT_SOFTCLIPPED_BASES}'
  id: clip_representation
  inputBinding:
    position: 0
    prefix: --clip-representation
  type: string?
- doc: 'Remove sequences within reads matching this sequence  This argument may be
    specified 0 or more times. Default value: null.'
  id: clip_sequence
  inputBinding:
    position: 0
    prefix: --clip-sequence
  type: string?
- doc: 'Remove sequences within reads matching the sequences in this FASTA file  Default
    value: .'
  id: clip_sequences_file
  inputBinding:
    position: 0
    prefix: --clip-sequences-file
  type: null?
...
- doc: 'If true, create a a MD5 digest any VCF file created.  Default value: false.
  ...
  type: boolean?
- doc: 'indicating machine cycles to clip from the reads  Default value: null.'
  id: cycles_to_trim
  inputBinding:
    position: 0
    prefix: --cycles-to-trim
  type: string?
...
- doc: 'Lenient processing of VCF files  Default value: false. Possible values: {true,
  ...
  inputBinding:
    ...
    prefix: --lenient
  type: boolean?
- doc: 'to output statistics  Default value: null.'
  ...
  type: File?
- doc: ''
  id: q_trimming_threshold
  inputBinding:
    position: 0
    prefix: --q-trimming-threshold
  type: int
