...
- doc: picard.jar
  ...
  inputBinding:
    ...
    prefix: -jar
  type: boolean?
- doc: The input VCF/BCF file.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: The output VCF/BCF file.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'read one or more arguments files and add them to the command line  This argument
  ...
  type: File?
- doc: Check only the first N records when searching for missing INFO and FORMAT fields.  Default
...
- doc: 'Whether to create an MD5 digest for any BAM or FASTQ files created.    Default
  ...
  type: boolean?
- doc: ':BooleanEnforce that the samples are the same (and in the same order) when
    replacing the VCF header.  Default value: true. Possible values: {true, false}'
...
- doc: 'Google Genomics API client_secrets.json file path.  Default value: client_secrets.json.'
  ...
  type: string?
- doc: 'The replacement VCF header.  Default value: null.'
  id: HEADER
  inputBinding:
    position: 0
    prefix: --HEADER
