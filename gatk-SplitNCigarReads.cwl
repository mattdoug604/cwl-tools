...
- doc: BAM/SAM/CRAM file containing reads  This argument must be specified at least
  ...
  inputBinding:
    ...
    prefix: --input
  type: string
- doc: Write output to this BAM filename  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'If specified, do not check the sequence dictionaries from our inputs for compatibility.
  ...
  type: boolean?
- doc: ':Booleando not have the walker soft-clip overhanging sections of the reads  Default
...
- doc: 'have the walker split secondary alignments (will still repair MC tag without
    it)  Default value: false. Possible values: {true, false}'
...
- doc: ':ValidationStringency Validation stringency for all SAM/BAM/CRAM/SRA files
  ...
  type: string?
- doc: 'refactor cigar string with NDN elements to one element  Default value: false.
    Possible values: {true, false}'
...
- doc: "If true, don't emit genotype fields when writing vcf file output.  Default\
  ...
  type: boolean?
- doc: 'skip the 255 -> 60 MQ read transform  Default value: false. Possible values:
    {true, false}'
...
- doc: 'Disable all tool default read filters (WARNING: many tools will not function
  ...
  type: boolean?
- doc: 'max reads allowed to be kept in memory at a time by the BAM writer  Default
    value: 150000.'
