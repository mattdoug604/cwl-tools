...
cwlVersion: v1.0
id: gatk_BuildBamIndex
inputs:
- doc: picard.jar BuildBamIndex \<br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: A BAM file or GA4GH URL to process. Must be sorted in coordinate order.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
...
- doc: 'The BAM index file. Defaults to x.bai if INPUT is x.bam, otherwise INPUT.bai.
    If INPUT is a URL and OUTPUT is unspecified, defaults to a file in the current
