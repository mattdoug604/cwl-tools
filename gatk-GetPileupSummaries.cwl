...
- doc: One or more genomic intervals over which to operate  This argument must be
  ...
  inputBinding:
    ...
    prefix: --intervals
  type: string
- doc: The output table  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
  type: File
- doc: :FeatureInput     A VCF file containing variants and allele frequencies  Required.
  id: variant
  inputBinding:
    position: 0
    prefix: --variant
...
- doc: 'Read filters to be disabled before analysis  This argument may be specified
    ...
    MappingQualityAvailableReadFilter, MappingQualityNotZeroReadFilter, MateOnSameContigOrNoMappedMateReadFilter,
    NonZeroReferenceLengthAlignmentReadFilter, NotDuplicateReadFilter, PassesVendorQualityCheckReadFilter,
    PrimaryLineReadFilter, WellformedReadFilter}'
...
- doc: 'Maximum number of reads to retain per sample per locus. Reads above this threshold
  ...
  type: int?
- doc: 'Maximum population allele frequency of sites to consider.  Default value:
    0.2.'
  ...
  type: double?
- doc: 'Minimum read mapping quality  Default value: 50.'
  id: min_mapping_quality
  inputBinding:
    position: 0
    prefix: --min-mapping-quality
  type: int?
- doc: 'Minimum population allele frequency of sites to consider.  A low value increases
    accuracy at the expense of speed.  Default value: 0.01.'
