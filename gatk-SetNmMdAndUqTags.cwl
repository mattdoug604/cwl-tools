...
cwlVersion: v1.0
id: gatk_SetNmMdAndUqTags
inputs:
- doc: picard.jar SetNmMdAndUqTags <br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: The BAM or SAM file to fix.   Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: File
- doc: The fixed BAM or SAM output file.   Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'Whether the file contains bisulfite sequence (used when calculating the NM
    tag).  Default value: false. Possible values: {true, false}'
...
- doc: 'Whether to suppress job-summary info on System.err.  Default value: false.
  ...
  inputBinding:
    ...
    prefix: --QUIET
  type: boolean?
- doc: 'Only set the UQ tag, ignore MD and NM.  Default value: false. Possible values:
    {true, false}'
  id: SET_ONLY_UQ
  inputBinding:
    position: 0
