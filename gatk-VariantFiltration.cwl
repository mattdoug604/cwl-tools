...
- doc: 'Size of the cloud-only prefetch buffer (in MB; 0 to disable).  Default value:
  ...
  type: int?
- doc: 'The number of SNPs which make up a cluster. Must be at least 2  Default value:
    3.'
  id: cluster_size
  inputBinding:
    position: 0
    prefix: --cluster-size
  type: int?
- doc: 'The window size (in bases) in which to evaluate clustered SNPs  Default value:
    0.'
...
- doc: ':StringOne or more genomic intervals to exclude from processing  This argument
  ...
  type: boolean?
- doc: 'One or more expression used with INFO fields to filter  This argument may
  ...
  type: string?
- doc: 'Names to use for the list of filters  This argument may be specified 0 or
  ...
  inputBinding:
    ...
    prefix: --filter-name
  type: string?
- doc: 'Filter records NOT in given input mask.  Default value: false. Possible values:
    {true, false}'
...
- doc: 'Project to bill when accessing "requester pays" buckets. If unset, these buckets
  ...
  type: string?
- doc: 'One or more expression used with FORMAT (sample/genotype-level) fields to
    filter (see documentation guide for more info)  This argument may be specified
...
- doc: 'Names to use for the list of sample/genotype filters (must be a 1-to-1 mapping);
    this name is put in the FILTER field for variants that get filtered  This argument
    may be specified 0 or more times. Default value: null.'
...
- doc: 'One or more genomic intervals over which to operate  This argument may be
  ...
  inputBinding:
    ...
    prefix: --intervals
  type: string?
- doc: 'Remove previous filters applied to the VCF  Default value: false. Possible
    values: {true, false}'
...
- doc: 'Lenient processing of VCF files  Default value: false. Possible values: {true,
  ...
  inputBinding:
    ...
    prefix: --lenient
  type: boolean?
- doc: ':FeatureInput     Input mask  Default value: null.'
  id: mask
  inputBinding:
    position: 0
    prefix: --mask
...
- doc: "The text to put in the FILTER field if a 'mask' is provided and overlaps with\
    \ a variant call  Default value: Mask."
  id: mask_name
  inputBinding:
    position: 0
    prefix: --mask-name
  type: string?
- doc: 'When evaluating the JEXL expressions, missing values should be considered
    failing the expression  Default value: false. Possible values: {true, false}'
