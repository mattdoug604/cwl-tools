...
cwlVersion: v1.0
id: gatk_CollectTargetedPcrMetrics
inputs:
- doc: picard.jar CollectTargetedPcrMetrics \<br />       I=input.bam \<br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
...
- doc: 'Whether to create an MD5 digest for any BAM or FASTQ files created.    Default
  ...
  type: boolean?
- doc: 'Custom amplicon set name. If not provided it is inferred from the filename
    of the AMPLICON_INTERVALS intervals.  Default value: null.'
...
- doc: ':MetricAccumulationLevel The level(s) at which to accumulate metrics.  This
  ...
  type: string?
- doc: 'Minimum base quality for a base to contribute coverage.  Default value: 0.'
