...
cwlVersion: v1.0
id: gatk_QualityScoreDistributionSpark
inputs:
- doc: 'If true, adds a command line header line to created VCF files.  Default value:
  ...
  type: boolean?
- doc: 'If set to true calculate mean quality over aligned reads only.  Default value:
...
- doc: 'maximum number of bytes to read from a file into each partition of reads.
  ...
  type: long?
- doc: 'A file (with .pdf extension) to write the chart to.  Default value: null.'
  id: chart
  inputBinding:
    position: 0
    prefix: --chart
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'If set to true, include quality for no-call bases in the distribution.  Default
...
- doc: 'For tools that shuffle data or write an output, sets the number of reducers.
  ...
  inputBinding:
    ...
    prefix: --num-reducers
  type: int?
- doc: 'uri for the output file: a local file path  Default value: null.'
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'when writing a bam, in single sharded mode this directory to write the temporary
  ...
  type: string?
- doc: 'If set to true calculate mean quality over PF reads only.  Default value:
    false. Possible values: {true, false}'
  id: pfReadsOnly
  inputBinding:
    position: 0
