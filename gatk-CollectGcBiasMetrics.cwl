...
cwlVersion: v1.0
id: gatk_CollectGcBiasMetrics
inputs:
- doc: is &gt; 50%) GC content respectively.  <br /><br />The percentage of
  id: GC
  inputBinding:
    position: 0
    prefix: -GC
...
- doc: The text file to write summary metrics to.  Required.
  ...
  type: File
- doc: 'Use to get additional results without duplicates. This option allows to gain
    two plots per level at the same time: one is the usual one and the other excludes
    duplicates.  Default value: false. Possible values: {true, false}'
...
- doc: 'For summary metrics, exclude GC windows that include less than this fraction
    of the genome.  Default value: 1.0E-5.'
