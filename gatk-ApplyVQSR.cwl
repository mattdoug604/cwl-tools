...
- doc: The output filtered and recalibrated VCF file in which each variant is annotated
    with its VQSLOD value  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
  type: string
- doc: :FeatureInput     The input recal file used by ApplyRecalibration  Required.
  id: recal_file
  inputBinding:
    position: 0
    prefix: --recal-file
...
- doc: 'If specified, do not check the sequence dictionaries from our inputs for compatibility.
  ...
  type: boolean?
- doc: "Don't output filtered loci after applying the recalibration  Default value:\
    \ false. Possible values: {true, false}"
  id: exclude_filtered
  inputBinding:
    position: 0
...
- doc: 'Lenient processing of VCF files  Default value: false. Possible values: {true,
  ...
  inputBinding:
    ...
    prefix: --lenient
  type: boolean?
- doc: ':Mode             Recalibration mode to employ: 1.) SNP for recalibrating
    only SNPs (emitting indels untouched in the output VCF); 2.) INDEL for indels;
    and 3.) BOTH for recalibrating both SNPs and indels simultaneously.  Default value:
    SNP. Possible values: {SNP, INDEL, BOTH}'
  id: mode
  inputBinding:
    position: 0
    prefix: --mode
...
- doc: 'Temp directory to use.  Default value: null.'
  ...
  inputBinding:
    ...
    prefix: --tmp-dir
  type: string?
- doc: 'The input tranches file describing where to cut the data  Default value: null.'
  id: tranches_file
  inputBinding:
    position: 0
    prefix: --tranches-file
  type: File?
- doc: 'The truth sensitivity level at which to start filtering  Default value: null.'
  id: truth_sensitivity_filter_level
  inputBinding:
    position: 0
    prefix: --truth-sensitivity-filter-level
  type: double?
- doc: 'If specified, the tool will attempt to apply a filter to each allele based
    on the input tranches and allele-specific .recal file.  Default value: false.
    Possible values: {true, false}'
...
- doc: 'Disable all tool default read filters (WARNING: many tools will not function
  ...
  type: boolean?
- doc: 'The VQSLOD score below which to start filtering  Default value: null.'
  id: lod_score_cutoff
  inputBinding:
    position: 0
    prefix: --lod-score-cutoff
  type: double?
