...
- doc: Output VCF file  Required.
  ...
  inputBinding:
    ...
    prefix: --output
  type: string
- doc: :FeatureInput A list of validated VCFs with known sites of common variation  This
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'The level(s) of sensitivity to indels in the resource VCFs at which to filter
    indels. Higher numbers mean more desired sensitivity and thus less stringent filtering.Specified
    in percents, i.e. 99.9 for 99.9 percent and 1.0 for 1 percent.  This argument
    may be specified 0 or more times. Default value: [99.0, 99.5].'
  id: indel_tranche
  inputBinding:
    position: 0
    prefix: --indel-tranche
  type: string?
- doc: 'The key must be in the INFO field of the input VCF.  Default value: CNN_2D.'
  id: info_key
  inputBinding:
    position: 0
    prefix: --info-key
...
- doc: 'One or more genomic intervals over which to operate  This argument may be
  ...
  inputBinding:
    ...
    prefix: --intervals
  type: string?
- doc: 'Remove all filters that already exist in the VCF.  Default value: false. Possible
    values: {true, false}'
...
- doc: "If true, don't emit genotype fields when writing vcf file output.  Default\
  ...
  type: boolean?
- doc: 'The level(s) of sensitivity to SNPs in the resource VCFs at which to filter
    SNPs. Higher numbers mean more desired sensitivity and thus less stringent filtering.Specified
    in percents, i.e. 99.9 for 99.9 percent and 1.0 for 1 percent.  This argument
    may be specified 0 or more times. Default value: [99.9, 99.99].'
  id: snp_tranche
  inputBinding:
    position: 0
    prefix: --snp-tranche
