...
cwlVersion: v1.0
id: gatk_AnnotateVcfWithExpectedAlleleFraction
inputs:
- doc: The input mixing fractions table  Required.
  id: mixing_fractions
  inputBinding:
    position: 0
    prefix: --mixing-fractions
  type: File
- doc: The output annotated VCF file  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
