...
cwlVersion: v1.0
id: gatk_FindBadGenomicKmersSpark
inputs:
- doc: input file by the
  id: kmers_to_ignore
  inputBinding:
    position: 0
    prefix: --kmers-to-ignore
  type: boolean?
- doc: for ubiquitous kmer output  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'additional high copy kmers (mitochondrion, e.g.) fasta file name  Default
    value: null.'
  id: high_copy_fasta
  inputBinding:
    position: 0
    prefix: --high-copy-fasta
  type: string?
