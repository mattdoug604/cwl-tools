...
- doc: One or more genomic intervals over which to operate  This argument must be
  ...
  inputBinding:
    ...
    prefix: --intervals
  type: string
- doc: Output file for annotated intervals.  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'Lenient processing of VCF files  Default value: false. Possible values: {true,
  ...
  inputBinding:
    ...
    prefix: --lenient
  type: boolean?
- doc: ':FeatureInput Path to Umap single-read mappability track in .bed or .bed.gz
    format (see https://bismap.hoffmanlab.org/).  Overlapping intervals must be merged.  Default
    value: .'
...
- doc: 'Output traversal statistics every time this many seconds elapse  Default value:
  ...
  type: double?
- doc: ':FeatureInput Path to segmental-duplication track in .bed or .bed.gz format.  Overlapping
    intervals must be merged.  Default value: null.'
