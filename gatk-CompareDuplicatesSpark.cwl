...
cwlVersion: v1.0
id: gatk_CompareDuplicatesSpark
inputs:
...
- doc: 'For tools that shuffle data or write an output, sets the number of reducers.
  ...
  inputBinding:
    ...
    prefix: --num-reducers
  type: int?
- doc: 'If output is given, the tool will return a bam with all the mismatching duplicate
    groups in the first specified file  Default value: null.'
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'when writing a bam, in single sharded mode this directory to write the temporary
  ...
  type: string?
- doc: 'If output is given, the tool will return a bam with all the mismatching duplicate
    groups in the second specified input file  Default value: null.'
  id: output2
  inputBinding:
    position: 0
    prefix: --output2
  type: string?
- doc: 'Print a summary  Default value: true. Possible values: {true, false}'
  id: print_summary
  inputBinding:
    position: 0
...
- doc: 'URL of the Spark Master to submit jobs to when using the Spark pipeline runner.  Default
  ...
  inputBinding:
    ...
    prefix: --spark-master
  type: string?
- doc: 'Throw error if any differences were found  Default value: false. Possible
    values: {true, false}'
  id: throw_on_diff
  inputBinding:
    position: 0
