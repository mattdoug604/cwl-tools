...
cwlVersion: v1.0
id: gatk_FilterByOrientationBias
inputs:
- doc: Output Somatic SNP/Indel VCF file  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: PreAdapter Detail metrics file.  Usually, generated by CollectSequencingArtifactMetrics.
    Required.
  id: pre_adapter_detail_file
  inputBinding:
    position: 0
    prefix: --pre-adapter-detail-file
  type: File
...
- doc: 'read one or more arguments files and add them to the command line  This argument
  ...
  type: File?
- doc: "PreAdapter Detail artifacts of interest on the forward strand.  'C/A' for\
    \ a single artifact.  Specify this parameter multiple times to process multiple\
    \ artifacts at the same time:  'C/A,T/G'  Artifacts must be one base to one base\
    \ (e.g. 'CC/CA' is illegal).  G>T is OxoG.  This argument may be specified 0 or\
