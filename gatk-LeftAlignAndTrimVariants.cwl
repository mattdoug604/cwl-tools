...
cwlVersion: v1.0
id: gatk_LeftAlignAndTrimVariants
inputs:
...
- doc: 'If specified, do not check the sequence dictionaries from our inputs for compatibility.
  ...
  type: boolean?
- doc: 'Do not Trim alleles to remove bases common to all of them  Default value:
    false. Possible values: {true, false}'
  id: dont_trim_alleles
  inputBinding:
    position: 0
    prefix: --dont-trim-alleles
  type: boolean?
...
- doc: 'Lenient processing of VCF files  Default value: false. Possible values: {true,
  ...
  inputBinding:
    ...
    prefix: --lenient
  type: boolean?
- doc: 'Set maximum indel size to realign  Default value: 200.'
  id: max_indel_length
  inputBinding:
    position: 0
    prefix: --max-indel-length
  type: int?
- doc: 'Set max reference window size to look back before allele  Default value: 1000.'
  id: max_leading_bases
  inputBinding:
    position: 0
    prefix: --max-leading-bases
  type: int?
...
- doc: "If true, don't emit genotype fields when writing vcf file output.  Default\
  ...
  type: boolean?
- doc: ':BooleanSplit multiallelic records and left-align individual alleles  Default
    value: false. Possible values: {true, false}'
  id: split_multi_allelics
  inputBinding:
    position: 0
    prefix: --split-multi-allelics
  type: boolean?
