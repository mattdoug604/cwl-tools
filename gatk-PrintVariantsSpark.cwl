...
cwlVersion: v1.0
id: gatk_PrintVariantsSpark
inputs:
- doc: Uri for the output file (a local file path).  Required.
  id: output
  inputBinding:
    position: 0
    prefix: --output
...
- doc: 'For tools that write an output, write the output in multiple pieces (shards)  Default
  ...
  type: boolean?
- doc: 'whether to use the shuffle implementation or not  Default value: false. Possible
    values: {true, false}'
  id: shuffle
  inputBinding:
    position: 0
...
- doc: 'Whether to use the JdkInflater (as opposed to IntelInflater)  Default value:
  ...
  type: boolean?
- doc: 'Maximum size of each variant shard, in bases.  Default value: 10000.'
  id: variantShardSize
  inputBinding:
    position: 0
    prefix: --variantShardSize
  type: int?
