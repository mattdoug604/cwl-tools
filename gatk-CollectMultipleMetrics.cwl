...
cwlVersion: v1.0
id: gatk_CollectMultipleMetrics
inputs:
- doc: picard.jar CollectMultipleMetrics \<br />      I=input.bam \<br />      O=multiple_metrics
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'If a read maps to a sequence specified with this option, all the bases in
    the read are counted as ignored bases.  This argument may be specified 0 or more
    times. Default value: .'
  id: IGNORE_SEQUENCE
  inputBinding:
    position: 0
...
- doc: 'Include unpaired reads in CollectSequencingArtifactMetrics. If set to true
    ...
    will be ignored in CollectSequencingArtifactMetrics.  Default value: false. Possible
    values: {true, false}'
  id: INCLUDE_UNPAIRED
  inputBinding:
    position: 0
...
- doc: ':MetricAccumulationLevel The level(s) at which to accumulate metrics.  This
  ...
  type: string?
- doc: ':Program             Set of metrics programs to apply during the pass through
    the SAM file.  This argument may be specified 0 or more times. Default value:
    [CollectAlignmentSummaryMetrics, CollectBaseDistributionByCycle, CollectInsertSizeMetrics,
    MeanQualityByCycle, QualityScoreDistribution]. Possible values: {CollectAlignmentSummaryMetrics,
    CollectInsertSizeMetrics, QualityScoreDistribution, MeanQualityByCycle, CollectBaseDistributionByCycle,
...
- doc: 'Whether to suppress job-summary info on System.err.  Default value: false.
  ...
  inputBinding:
    ...
    prefix: --QUIET
  type: boolean?
- doc: 'Gene annotations in refFlat form.  Format described here: http://genome.ucsc.edu/goldenPath/gbdDescriptionsOld.html#RefFlat  Default
    value: null.'
  id: REF_FLAT
  inputBinding:
    position: 0
