...
cwlVersion: v1.0
id: gatk_DownsampleSam
inputs:
- doc: picard.jar DownsampleSam \
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
...
- doc: The input SAM or BAM file to downsample.  Required.
  ...
  inputBinding:
    ...
    prefix: --INPUT
  type: File
- doc: The output, downsampled, SAM or BAM file to write.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
  type: File
- doc: 'The accuracy that the downsampler should try to achieve if the selected strategy
    supports it. Note that accuracy is never guaranteed, but some strategies will
    attempt to provide accuracy within the requested bounds.Higher accuracy will generally
    require more memory. Default value: 1.0E-4.'
  id: ACCURACY
  inputBinding:
    position: 0
    prefix: --ACCURACY
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'The metrics file (of type QualityYieldMetrics) which will contain information
    about the downsampled file.  Default value: null.'
  id: METRICS_FILE
  inputBinding:
    position: 0
    prefix: --METRICS_FILE
  type: File?
- doc: 'The probability of keeping any individual read, between 0 and 1.  Default
    value: 1.0.'
  id: PROBABILITY
  inputBinding:
    position: 0
...
- doc: 'Whether to suppress job-summary info on System.err.  Default value: false.
  ...
  inputBinding:
    ...
    prefix: --QUIET
  type: boolean?
- doc: 'Random seed used for deterministic results. Setting to null will cause multiple
    invocations to produce different results.  Default value: 1.'
  id: RANDOM_SEED
  inputBinding:
    position: 0
    prefix: --RANDOM_SEED
...
- doc: 'The reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: ':Strategy        The downsampling strategy to use. See usage for discussion.  Default
    value: ConstantMemory. Possible values: {HighAccuracy, ConstantMemory, Chained}'
  id: STRATEGY
  inputBinding:
    position: 0
    prefix: --STRATEGY
