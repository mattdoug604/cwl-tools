...
cwlVersion: v1.0
id: gatk_CollectIlluminaBasecallingMetrics
inputs:
- doc: picard.jar CollectIlluminaBasecallingMetrics \<br />      BASECALLS_DIR=/BaseCalls/
    \<br />      LANE=001 \<br />
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: The Illumina basecalls output directory from which data are read  Required.
  id: BASECALLS_DIR
  inputBinding:
    position: 0
    prefix: --BASECALLS_DIR
  type: File
- doc: The lane whose data will be read  Required.
  id: LANE
  inputBinding:
    position: 0
    prefix: --LANE
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'The file containing barcodes to expect from the run - barcodeData.#  Default
    value: null.'
  id: INPUT
  inputBinding:
    position: 0
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'The file to which the collected metrics are written  Default value: null.'
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
