...
- doc: 'when writing a bam, in single sharded mode this directory to write the temporary
  ...
  type: string?
- doc: 'Input queryname-sorted BAM containing only paired reads  Default value: null.'
  id: paired_input
  inputBinding:
    position: 0
    prefix: --paired-input
  type: string?
- doc: 'Output BAM containing only paired reads  Default value: null.'
  id: paired_output
  inputBinding:
    position: 0
...
- doc: 'Temp directory to use.  Default value: null.'
  ...
  inputBinding:
    ...
    prefix: --tmp-dir
  type: string?
- doc: 'Input BAM containing only unpaired reads  Default value: null.'
  id: unpaired_input
  inputBinding:
    position: 0
    prefix: --unpaired-input
  type: string?
- doc: 'Output BAM containing only unpaired reads  Default value: null.'
  id: unpaired_output
  inputBinding:
    position: 0
    prefix: --unpaired-output
  type: string?
