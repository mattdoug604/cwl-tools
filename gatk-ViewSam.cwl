...
id: gatk_ViewSam
inputs:
- doc: picard.jar ViewSam  <br />      I=sample.bam  <br />      HEADER_ONLY=true</pre>
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: ':AlignmentStatus Print out all reads, just the aligned reads or just the unaligned
    reads.  Required. Possible values: {Aligned, Unaligned, All}'
  id: ALIGNMENT_STATUS
  inputBinding:
    position: 0
    prefix: --ALIGNMENT_STATUS
  type: string
- doc: The SAM or BAM file or GA4GH url to view.  Required.
  id: INPUT
  inputBinding:
    position: 0
    prefix: --INPUT
  type: string
- doc: ':PfStatus          Print out all reads, just the PF reads or just the non-PF
    reads.  Required. Possible values: {PF, NonPF, All}'
  id: PF_STATUS
  inputBinding:
    position: 0
    prefix: --PF_STATUS
...
- doc: 'Google Genomics API client_secrets.json file path.  Default value: client_secrets.json.'
  ...
  type: string?
- doc: 'Print the SAM header only.  Default value: false. Possible values: {true,
    false}'
  id: HEADER_ONLY
  inputBinding:
    position: 0
...
- doc: 'display the help message  Default value: false. Possible values: {true, false}'
  ...
  inputBinding:
    ...
    prefix: --help
  type: boolean?
- doc: 'An intervals file used to restrict what records are output.  Default value:
    null.'
  id: INTERVAL_LIST
  inputBinding:
    position: 0
...
- doc: 'Whether to suppress job-summary info on System.err.  Default value: false.
  ...
  inputBinding:
    ...
    prefix: --QUIET
  type: boolean?
- doc: 'Print the alignment records only.  Default value: false. Possible values:
    {true, false}'
  id: RECORDS_ONLY
  inputBinding:
    position: 0
