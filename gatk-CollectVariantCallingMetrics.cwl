...
cwlVersion: v1.0
id: gatk_CollectVariantCallingMetrics
inputs:
...
- doc: Input vcf file for analysis  Required.
  ...
  inputBinding:
    ...
    prefix: --INPUT
  type: File
- doc: Path (except for the file extension) of output metrics files to write.  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'Google Genomics API client_secrets.json file path.  Default value: client_secrets.json.'
  ...
  type: string?
- doc: 'Set to true if running on a single-sample gvcf.  Default value: false. Possible
    values: {true, false}'
  id: GVCF_INPUT
  inputBinding:
    position: 0
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: ':FileIf present, speeds loading of dbSNP file, will look for dictionary in
    vcf if not present here.  Default value: null.'
  id: SEQUENCE_DICTIONARY
  inputBinding:
    position: 0
    prefix: --SEQUENCE_DICTIONARY
  type: boolean?
- doc: 'Target intervals to restrict analysis to.  Default value: null.'
  id: TARGET_INTERVALS
  inputBinding:
    position: 0
    prefix: --TARGET_INTERVALS
  type: File?
- doc: 'Undocumented option  Default value: 1.'
  id: THREAD_COUNT
  inputBinding:
    position: 0
    prefix: --THREAD_COUNT
