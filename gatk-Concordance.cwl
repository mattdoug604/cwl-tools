...
id: gatk_Concordance
inputs:
- doc: ). Note that this tool assumes that the truth VCF only contains PASS variants.
  id: summary
  inputBinding:
    position: 0
    prefix: --summary
  type: boolean?
- doc: A VCF containing variants to be compared to the truth  Required.
  id: evaluation
  inputBinding:
    position: 0
    prefix: --evaluation
  type: string
- doc: A VCF containing truth variants  Required.
  id: truth
  inputBinding:
    position: 0
    prefix: --truth
...
- doc: 'Size of the cloud-only prefetch buffer (in MB; 0 to disable).  Default value:
  ...
  type: int?
- doc: 'TO BE IMPLEMENTED  Default value: null.'
  id: confidence
  inputBinding:
    position: 0
    prefix: --confidence
...
- doc: ':StringOne or more genomic intervals to exclude from processing  This argument
  ...
  type: boolean?
- doc: 'A table of the contribution of each filter to true and false negatives  Default
    value: .'
  id: filter_analysis
  inputBinding:
    position: 0
  ...
  type: null?
- doc: 'A vcf to write filtered true negatives and false negatives  Default value:
    null.'
  id: filtered_true_negatives_and_false_negatives
  inputBinding:
    position: 0
    prefix: --filtered-true-negatives-and-false-negatives
  type: File?
...
- doc: 'Temp directory to use.  Default value: null.'
  ...
  inputBinding:
    ...
    prefix: --tmp-dir
  type: string?
- doc: 'A vcf to write true positives and false negatives  Default value: null.'
  id: true_positives_and_false_negatives
  inputBinding:
    position: 0
    prefix: --true-positives-and-false-negatives
  type: File?
- doc: 'A vcf to write true positives and false positives  Default value: null.'
  id: true_positives_and_false_positives
  inputBinding:
    position: 0
    prefix: --true-positives-and-false-positives
  type: File?
