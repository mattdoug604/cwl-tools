...
cwlVersion: v1.0
id: gatk_CollectJumpingLibraryMetrics
inputs:
- doc: picard.jar CollectJumpingLibraryMetrics \<br />      I=input.bam
  id: jar
  inputBinding:
    position: 0
    prefix: -jar
  type: boolean?
- doc: BAM file(s) of reads with duplicates marked  This argument must be specified
  ...
  inputBinding:
    ...
    prefix: --INPUT
  type: File
- doc: to which metrics should be written  Required.
  id: OUTPUT
  inputBinding:
    position: 0
    prefix: --OUTPUT
...
- doc: 'read one or more arguments files and add them to the command line  This argument
  ...
  type: File?
- doc: 'Jumps greater than or equal to the greater of this value or 2 times the mode
    of the outward-facing pairs are considered chimeras  Default value: 100000.'
  id: CHIMERA_KB_MIN
  inputBinding:
    position: 0
...
- doc: 'When writing files that need to be sorted, this will specify the number of
  ...
  type: int?
- doc: 'Mapping quality minimum cutoff  Default value: 0.'
...
- doc: 'Reference sequence file.  Default value: null.'
  ...
  type: File?
- doc: 'When calculating mean and stdev stop when the bins in the tail of the distribution
    contain fewer than mode/TAIL_LIMIT items  Default value: 10000.'
  id: TAIL_LIMIT
  inputBinding:
    position: 0
    prefix: --TAIL_LIMIT
